...
* `rax` - регистры общего назначения, сохраняется на стэк при прерывании
* `rbx` - регистры общего назначения
* `rdx` - регистры общего назначения
...
| Никитин Егор Алексеевич | hello            | 14  | -         | 26          | 73     | 210   | asm | cisc | neum | hw | instr | binary | trap | port | pstr | prob1 | spi |
| Никитин Егор Алексеевич | cat              | 13  | -         | 13          | 46     | 139   | asm | cisc | neum | hw | instr | binary | trap | port | pstr | prob1 | spi |
| Никитин Егор Алексеевич | hello_user_name  | 53  | -         | 95          | 201    | 607   | asm | cisc | neum | hw | instr | binary | trap | port | pstr | prob1 | spi |
| Никитин Егор Алексеевич | prob1            | 37  | -         | 37          | 10124  | 19244 | asm | cisc | neum | hw | instr | binary | trap | port | pstr | prob1 | spi |
```
