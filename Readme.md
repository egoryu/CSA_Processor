...
- Метод `command_cycle` моделирует моделирует выполнение полного цикла команд 
- Метод `decode_and_execute_instruction` моделирует выполнение цикл выборки инструкции,
